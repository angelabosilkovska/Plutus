...
fun AccountRow(
    ...
    BaseRow(
        ...
        color = color,
        title = name,
        subtitle = stringResource(Res.string.account_redacted) + formatAccountNumber(number),
        amount = amount,
        negative = false
    )
}
...
@Composable
fun BillRow(modifier: Modifier = Modifier, name: String, due: String, amount: Float, color: Color) {
    BaseRow(
        modifier = modifier,
        color = color,
        title = name,
...
@Composable
fun PlutusDivider(modifier: Modifier = Modifier) {
